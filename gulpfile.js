...
gulp.task('watch:staging-api', 'starts up browsersync server and runs task watchers, remote proxy to staging api', [], browserStack(3002));
...
gulp.task('test', 'executes all unit tests', ['test:app']);
